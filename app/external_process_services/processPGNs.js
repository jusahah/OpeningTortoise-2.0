...
module.exports = parsePgnsWrapper;

// This is so that we can use with threads library
// If not using threads library, use 'module.exports = parsePgns'
function parsePgnsWrapper(input, done) {
	done(parsePgns(input));
}
